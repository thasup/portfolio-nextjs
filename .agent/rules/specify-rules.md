# portfolio-nextjs Development Guidelines
...
- TypeScript 5.7, React 19, Next.js 15.2 (App Router) + Framer Motion 11.18, next-intl 4.8, lucide-react 0.469, shadcn/ui (Radix UI primitives) (003-vertical-scroll-timeline)
- Static TypeScript data files in `src/data/`, no database (003-vertical-scroll-timeline)
