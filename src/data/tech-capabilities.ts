...
export const capabilities: Capability[] = [
  {
    ...
    subsystems: [
      ...
      },
      {
        ...
        tools: [{ name: "TypeScript", primary: true }, { name: "JavaScript" }],
      },
      {
      ...
      },
      {
        ...
        tools: [{ name: "Zod" }, { name: "React Hook Form" }],
      },
      {
      ...
      },
      {
        ...
        tools: [{ name: "Vitest" }, { name: "Jest" }, { name: "Playwright" }],
      },
      {
  ...
  },
  {
    ...
    subsystems: [
      ...
      },
      {
        ...
        tools: [{ name: "Python" }, { name: "PHP" }],
      },
      {
        nameKey: "tech.subsystems.data_layer",
        tools: [{ name: "PostgreSQL", primary: true }, { name: "MongoDB" }],
      },
      {
  ...
  },
  {
    ...
    subsystems: [
      ...
      },
      {
        ...
        tools: [{ name: "Amazon Bedrock" }, { name: "Amazon SageMaker" }],
      },
      {
        nameKey: "tech.subsystems.automation_workflow",
        tools: [{ name: "Zapier" }, { name: "n8n" }],
      },
    ],
  },
  {
    ...
    subsystems: [
      ...
      },
      {
        ...
        tools: [{ name: "Sentry", primary: true }, { name: "OpenTelemetry" }],
      },
      {
