...
function renderOutline(outline: ReadonlyArray<OutlineUnit>): string {
  return outline
    .map(
      (u, i) => `${i + 1}. ${u.title} — ${clamp(u.summary, MAX_SUMMARY_CHARS)}`,
    )
    .join("\n");
}
...
export const fixtures: ReadonlyArray<PromptFixture<OnboardingMetaInput>> = [
      ...
      outline: [
        {
          ...
          objective: "",
          summary: "Openers that earn attention.",
        },
        {
          title: "Finding real pain",
          objective: "",
          summary: "Diagnostic questions that surface root problems.",
        },
        {
          title: "Handling objections",
          objective: "",
          summary: "Acknowledge, reframe, invite.",
        },
      ],
    },
  },
      ...
      outline: [
        {
          ...
          objective: "",
          summary: "The shape of a query.",
        },
        {
          title: "Joining tables",
          objective: "",
          summary: "How relations line up across tables.",
        },
        {
          title: "Aggregating and grouping",
          objective: "",
          summary: "Summarising rows into answers.",
        },
      ],
    },
  },
  {
    ...
    input: {
      ...
      outline: [
        {
          title: "Building a pantry",
          objective: "",
          summary: "Five pastes, three sauces, two starches.",
        },
        {
          title: "Balancing the four flavours",
          objective: "",
          summary: "Sweet, salty, sour, spicy on one plate.",
        },
        {
          title: "Cooking a full meal",
          objective: "",
          summary: "Three dishes that share prep.",
        },
      ],
    },
  },
