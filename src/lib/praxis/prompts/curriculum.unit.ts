...
const SALES_OUTLINE: ReadonlyArray<OutlineUnit> = [
  {
    ...
    objective:
      "By the end you can open a discovery call without losing attention in the first minute.",
    summary:
  ...
  },
  {
    ...
    objective:
      "By the end you can ask for the next step in a way the prospect welcomes.",
    summary:
