  ...
  public: {
    Tables: {
      praxis_conversations: {
        ...
        Relationships: [
          {
            foreignKeyName: "praxis_conversations_user_id_fkey";
            columns: ["user_id"];
            isOneToOne: false;
      ...
      praxis_onboarding: {
        ...
        Relationships: [
          {
            foreignKeyName: "praxis_onboarding_user_id_fkey";
            columns: ["user_id"];
            isOneToOne: false;
            referencedRelation: "nexus_users";
            referencedColumns: ["id"];
      ...
      praxis_templates: {
        ...
        Relationships: [
          {
            foreignKeyName: "praxis_templates_user_id_fkey";
            columns: ["user_id"];
            isOneToOne: false;
            referencedRelation: "nexus_users";
            referencedColumns: ["id"];
      ...
      praxis_topics: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "praxis_topics_user_id_fkey";
            columns: ["user_id"];
            isOneToOne: false;
            referencedRelation: "nexus_users";
            referencedColumns: ["id"];
