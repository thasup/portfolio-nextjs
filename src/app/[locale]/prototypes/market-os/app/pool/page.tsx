...
export default async function PoolPage() {
  ...
  return (
    <AppPage>
      ...
      >
        Every period, a fixed share of revenue flows into the pool. The pool
        funds missions, base comp, and a small unallocated buffer. If revenue
        stalls, so does the pool.
      </p>
          ...
          {(
            ...
            <div key={label} style={{ marginBottom: 14 }}>
              ...
              >
                ...
                <span style={{ color: AC.dark, fontWeight: 700 }}>
                  {fmtBudget(val)}
                </span>
              </div>
              <div
        ...
        {payouts.map((p, i) => (
          <div
            ...
            style={{
              ...
              padding: "14px 28px",
              borderBottom:
                i < payouts.length - 1 ? `1px solid ${AC.border}` : "none",
            }}
          >
            <div
              style={{
