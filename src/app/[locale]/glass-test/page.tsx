    ...
    <>
      ...
      >
        ...
        <div className="relative container mx-auto py-20 text-white space-y-16">
          ...
          <div className="glass-scroll-track space-y-24">
      ...
      <style
        dangerouslySetInnerHTML={{
          __html: `
            ...
            .glass-test-page .glass-container {
              position: relative;
              display: flex;
              align-items: center;
            ...
            .glass-test-page .glass-container::before {
              content: '';
              position: absolute;
              inset: 0;
              z-index: 0;
              border-radius: 30px;
              box-shadow: inset 2px 2px 0px -2px rgba(255, 255, 255, 0.45), inset 0 0 16px 2px rgba(15, 23, 42, 0.35);
              background:
                radial-gradient(circle at 25% 20%, rgba(255, 255, 255, 0.35), transparent 55%),
                radial-gradient(circle at 80% 80%, rgba(15, 23, 42, 0.25), transparent 60%);
            }

            .glass-test-page .glass-container::after {
              content: '';
              position: absolute;
              inset: 0;
              border-radius: 30px;
              border: 1px solid rgba(255, 255, 255, 0.2);
              background: linear-gradient(135deg, rgba(15, 23, 42, 0.4), rgba(15, 23, 42, 0.15));
              backdrop-filter: blur(22px) saturate(135%);
              z-index: -1;
            }

            .glass-test-page .glass-btn {
              position: relative;
              display: flex;
              align-items: center;
              justify-content: center;
            ...
            .glass-test-page .glass-btn:hover {
              transform: scale(1.05);
              color: rgba(255, 255, 255, 0.9);
            }

            .glass-test-page .glass-btn::before {
              content: '';
              position: absolute;
              inset: 0;
              border-radius: 9999px;
            ...
            .glass-test-page .glass-btn::after {
              content: '';
              position: absolute;
              inset: 0;
              border-radius: 9999px;
