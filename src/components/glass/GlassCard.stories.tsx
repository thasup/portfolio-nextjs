...
const meta: Meta<typeof GlassCard> = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          "Versatile glassmorphism card component with multiple elevation levels, hover states, and interactive effects. Supports specular highlights, liquid distortion, and shine overlays for premium visual experiences.",
      },
    },
  },
};
...
export const Default: Story = {
    ...
    children: (
      <div className="p-6 max-w-sm">
        ...
        <p className="text-muted-foreground">
          Experience glassmorphism design with subtle backdrop blur and elegant
  ...
  parameters: {
    docs: {
      description: {
        story:
          "Standard glass card with default elevation (e2) and subtle backdrop blur.",
      },
    },
  },
};
...
export const WithSpecular: Story = {
  args: {
    children: (
      <div className="p-6 max-w-sm">
        ...
        <p className="text-muted-foreground">
          Move your cursor to reveal specular lighting that follows your
          movement.
        </p>
      </div>
    ),
  ...
  parameters: {
    docs: {
      description: {
        story:
          "Card with specular highlight effect that tracks cursor position. Creates a premium, interactive experience.",
      },
    },
  },
};
  ...
  args: {
    ...
    children: (
      <div className="p-6 relative z-10">
        ...
        <p className="text-muted-foreground">
          This card features the organic liquid distortion effect with edge
          shine.
        </p>
      </div>
    ),
