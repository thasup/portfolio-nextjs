...
const ROWS = [
  { title: 'Redesign onboarding flow', cat: 'Design', budget: '$8,400', status: 'open', bids: 2 },
  { title: 'Q2 competitive analysis', cat: 'Research', budget: '$3,200', status: 'open', bids: 1 },
  { title: 'Backend API audit', cat: 'Engineering', budget: '$6,800', status: 'active', bids: 4 },
  { title: 'Launch email campaign', cat: 'Marketing', budget: '$5,600', status: 'open', bids: 0 },
];
