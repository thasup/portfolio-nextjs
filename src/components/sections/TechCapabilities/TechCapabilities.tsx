...
const LAYERS = ['User Experience', 'System Architecture', 'Intelligence', 'Business Impact'];
    ...
    <section id="skills" className="section-padding">
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        ...
        >
          ...
          <div className="mt-5 flex flex-wrap items-center justify-center gap-2" aria-label="Capability layers">
            {LAYERS.map((layer, i) => (
