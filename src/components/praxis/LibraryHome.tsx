  ...
  return (
    <>
      <div className="hero">
        ...
        <p className="sub">
          This is your personal learning environment. Every topic here is
          generated specifically for you, tailored to your pace and goals.
        </p>
        ...
        {canGenerateTopics && (
          <div className="teach-box">
            ...
            <div className="row">
              ...
              <Link href="/prototypes/praxis/new" className="btn sm">
                Build syllabus
              </Link>
            </div>
          </div>
